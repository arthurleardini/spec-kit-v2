...
description: Use quando o usuário quer gerar ou revisar o blueprint do produto — a visão geral da solução como cadeia de valor — na Camada de Requisitos do modelo wikiLLM.
---

# contrato-blueprint

Gera o documento `blueprint.md` da Camada de Requisitos no wiki, em `refined/blueprint.md`.
...
## Entrada
Os docs de feature em `refined/Requisitos/` e a Camada de Intenção em `refined/visao.md` (produto, jobs, personas). Se a fonte for documento binário (PDF/DOCX/PPTX), converter com `markitdown` antes de ler.

## Processo
1. Ler os docs de feature em `refined/Requisitos/` e a Camada de Intenção para entender o produto e suas features.
