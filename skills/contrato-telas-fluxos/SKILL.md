...
## Entrada
A Camada de Intenção consolidada em `refined/visao.md` (produto, personas, jobs, regras) e a fonte da feature: qualquer conversa/brainstorm ou documento associado à feature. Se a fonte for documento binário (PDF/DOCX/PPTX), converter com `markitdown` antes de ler.
