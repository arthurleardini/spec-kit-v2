...
3. Propagar o conteúdo para os documentos afetados — `intencao/`, `entities/`, `concepts/`, `contracts/`.
...
4. Se a resposta for valiosa/reutilizável, arquivá-la como página em `refined/analyses/` — isso dispara um mini-ingest: atualizar `index.md` e anexar entrada em `log.md` (`## [YYYY-MM-DD] query | <título>`).

## Saída
- **ingest:** documentos do wiki atualizados, conflitos marcados com `⚠ CONTRADIÇÃO`, `index.md` e `log.md` atualizados.
- **query:** resposta com citações; opcionalmente uma página nova em `refined/analyses/` com `index.md`/`log.md` atualizados.
