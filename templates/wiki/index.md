...
<Catálogo de todas as páginas do wiki, por categoria. Ler PRIMEIRO ao responder uma query.
Manter atualizado a cada operação de ingest/migration. Um marcador por página, com link
relativo e uma linha de descrição.>

## Visão geral
- [overview](overview.md) — síntese e mapa do wiki
